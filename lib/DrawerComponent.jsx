...
const DrawerComponent = ( { text = 'Connect', className } ) =>
{
    return (
        <Drawer>
            ...
            <DrawerTrigger
                className={`${!className
                    ? 'bg-transparent rounded-full border-2 hover:border-[1px] hover:bg-brand-600 px-6 p-2 border-brand-100 transition  ease-linear'
                    : className
                    }`}
            >
                {text}
            ...
            <DrawerContent>
                <div className="mx-auto w-full max-w-sm">
                    <DrawerHeader className="flex flex-col text-xl justify-center items-center">
                        <DrawerTitle>
